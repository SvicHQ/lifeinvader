...
if (typeof window.itemsLoaded === 'undefined') {
    ...
    const backpackSkins = [
        ...
        "unique rims of type 2, 3 and 20",
        "valuable container",
        "Valentine gift",
        "video card",
        "vodka-shotka",
        ...
        "Hiring a personal assistant. Salary: Negotiable.",
        "a variety of items for good prices at beach market shop №27.",
        "juices for good prices at beach market shop №21.",
        "desert scarf mask for good price at beach market shop №23.",
        "a special license plate.",
        "license plate (1ABC234).",
        "a sim-card with number 11-11-111.",
        "sim-cards with numbers 11-11-111 and 22-22-222.",
        "a variety of items at private market stall next to Paleto Bay Parking.",
